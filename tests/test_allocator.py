...
def test_0_instances():
    """Test to check if the allocator will work correctly if the demand of some instance is 0 all the time."""
...
def test_4_instances():
    """Test to check if the allocator will work correctly in a favorable scenario, without round problems."""
...
def test_max_demand_first_hour():
    """Test to check if the allocator will work correctly when the demand has a peak only in the first hour."""
...
def test_max_demand_last_hour():
    """Test to check if the allocator will work correctly when the demand has a peak only in the last hour."""
...
def test_10_ond_20_noup_30_partialup_40_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
       10% OnDemand, 20% NoUpFront, 30% PartialUpFront, and 40% AllUpFront"""
...
def test_40_ond_30_noup_20_partialup_10_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
       40% OnDemand, 30% NoUpFront, 20% PartialUpFront, and 10% AllUpFront"""
...
def test_25_ond_25_noup_25_partialup_25_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
       25% OnDemand, 25% NoUpFront, 25% PartialUpFront, and 25% AllUpFront"""
...
def test_0_ond_40_noup_30_partialup_30_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
    0% OnDemand, 40% NoUpFront, 30% PartialUpFront, and 30% AllUpFront"""
...
def test_30_ond_0_noup_40_partialup_30_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
       30% OnDemand, 0% NoUpFront, 40% PartialUpFront, and 30% AllUpFront"""
...
def test_30_ond_40_noup_0_partialup_30_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
       30% OnDemand, 40% NoUpFront, 0% PartialUpFront, and 30% AllUpFront"""
...
def test_20_ond_50_noup_30_partialup_0_allup():
    """Test to ensure the allocator functions works correctly with varying proportions:
       20% OnDemand, 50% NoUpFront, 30% PartialUpFront, and 0% AllUpFront"""
...
def aux_allocator_test(mock_file, proportions, expected_allocation):
    """Auxiliar function that execute the asserts of all test cases"""
